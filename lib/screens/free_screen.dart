...
class FreeScreen extends StatefulWidget {
  FreeScreen({Key? key, this.clips}) : super(key: key);
  final List<FreeVideo>? clips;
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          _clips!.length == 0
                              ...
                              : Text(
                                  '''This is the metta of the teacher!''',
                                  style: TextStyle(
                                    fontSize: 20,
