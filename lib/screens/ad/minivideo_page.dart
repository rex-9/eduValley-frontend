...
class MinivideoPage extends StatefulWidget {
  MinivideoPage({Key? key, this.clips, this.func, this.zip, required this.name})
      : super(key: key);
  final Function? func;
  final List<Minivideo>? clips;
  final String? zip;
  final String name;

  @override
  _MinivideoPageState createState() => _MinivideoPageState();
}

class _MinivideoPageState extends State<MinivideoPage> {
  VideoPlayerController? _controller;
  List<Minivideo>? get _clips {
    return widget.clips;
  }
              ...
              : SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      _zip == null
                          ? SizedBox()
                          : urlButton(context, _zip!, 'Visit $_name'),
                    ],
                  ),
                ),
    );
